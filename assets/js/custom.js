(function($) {
  ...
  var testimonialSlider = new Swiper('.testimonial-slider-container', {
    ...
    autoplay: true,
    navigation: {
      nextEl: '.testimonial-default-area .swiper-btn-next',
      prevEl: '.testimonial-default-area .swiper-btn-prev',
    },
    pagination: {
      el: '.swiper-pagination',
      clickable: true
  ...
  var clientSlider = new Swiper('.client-slider-container', {
    slidesPerView : 4,
    speed: 1000,
    loop: true,
    spaceBetween : 30,
  ...
  var serviceSlider = new Swiper('.service-slider-container', {
    ...
    autoplay: false,
    navigation: {
      nextEl: '.service-default-area .swiper-btn-next',
      prevEl: '.service-default-area .swiper-btn-prev',
    },
    pagination: {
      el: '.swiper-pagination',
      clickable: true
